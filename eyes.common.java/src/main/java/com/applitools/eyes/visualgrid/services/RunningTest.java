...
public class RunningTest {
    ...
    public RunningTest(DesktopBrowserInfo browserInfo, Logger logger, SeleniumConfigurationProvider configurationProvider) {
        this.browserInfo = browserInfo;
    ...
    public RunningTest(IEyesConnector eyes, SeleniumConfigurationProvider configurationProvider, DesktopBrowserInfo browserInfo, Logger logger, RunningTestListener listener) {
        this.eyes = eyes;
        this.browserInfo = browserInfo;
        this.configurationProvider = configurationProvider;
