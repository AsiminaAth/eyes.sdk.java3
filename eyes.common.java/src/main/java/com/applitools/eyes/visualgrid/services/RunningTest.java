...
public class RunningTest {
    ...
    public RunningTest(DesktopBrowserInfo browserInfo, Logger logger, Configuration configuration) {
        this.browserInfo = browserInfo;
    ...
    public RunningTest(IEyesConnector eyes, Configuration configuration, DesktopBrowserInfo browserInfo, Logger logger, RunningTestListener listener) {
        this.eyes = eyes;
        this.browserInfo = browserInfo;
        this.configuration = configuration;
