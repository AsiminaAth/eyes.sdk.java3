...
public class VisualGridEyes implements ISeleniumEyes, IRenderingEyes {
    ...
    public WebDriver open(WebDriver webDriver) {
        ...
        List<DesktopBrowserInfo> browserInfoList = getConfiguration().getBrowsersInfo();
        ...
        if (getConfiguration().getBrowsersInfo() == null) {
            ...
            getConfiguration().addBrowser(new DesktopBrowserInfo(viewportSize.getWidth(), viewportSize.getHeight(), BrowserType.CHROME, getConfiguration().getBaselineEnvName()));
        }
    ...
    private void ensureBrowsers() {
        if (this.getConfiguration().getBrowsersInfo().isEmpty()) {
            getConfiguration().getBrowsersInfo().add(new DesktopBrowserInfo(viewportSize, BrowserType.CHROME));
        }
    }
